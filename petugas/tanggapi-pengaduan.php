            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="tambah-tanggapan.php?id_pengaduan=<?php echo $row['id_pengaduan'] ?>&aksi=edit" class="edithapus"><button type="submit" class="btn btn-warning edit">Tanggapi</button></a>
                        </td>
                    </tr>
                </tbody>
                <?php endforeach; ?>
