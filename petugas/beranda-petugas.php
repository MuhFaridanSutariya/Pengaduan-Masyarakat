    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="beranda-petugas.php"><strong>USER PETUGAS</strong></a>
            </div>
		...
		<div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Dashboard <small>Welcome Petugas</small>
                        </h1>
						<ol class="breadcrumb">
            ...
            <div id="page-inner">
                <h4 class="sambutan">Selamat Datang Petugas</h4>
