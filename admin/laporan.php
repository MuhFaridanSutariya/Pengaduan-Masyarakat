<?php 
    ...
    $db = new Controller();
    $db_laporan_masyarakat = $db->tampil_tanggapan();
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="beranda-masyarakat.php"><strong>USER ADMIN</strong></a>
            </div>
		...
		<div id="page-wrapper">
		  <div class="header"> 
					...
					<ol class="breadcrumb">
                        <li><a href="beranda-admin.php">Dashboard</a></li>
					</ol> 
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover">
                ...
                <?php 
                $i = 1;
                foreach((array)$db_laporan_masyarakat as $row) :
                ?>
                <tbody>
                    <tr>
                        <td><?php echo $i++; ?></td>
            ...
            <a href="cetak-laporan.php" target="_blank"><button class="btn btn-primary">CETAK</button></a>
        </div>
    </div>
</div>
