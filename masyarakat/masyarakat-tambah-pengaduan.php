...
<body>
    <div id="wrapper">
        ...
        <div class="header"> 
					    ...
					    <li><a href="masyarakat-tambah-pengaduan.php">Tambah Data</a></li>
					</ol> 
                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form action="proses-laporan.php?aksi=tambah" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Tanggal Pengaduan</label>
                                            <input type="date" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Petugas" name="tgl_pengaduan" value="<?php echo date("d-m-Y"); ?>">
                                        </div>
                                        <!-- <div class="form-group">
